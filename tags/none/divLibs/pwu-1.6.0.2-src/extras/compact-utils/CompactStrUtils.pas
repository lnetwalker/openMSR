{
 ...
 and finalization on which many functions do not rely! Initialization
 and finalization costs you extra bloat, because smartlinking does not pay
 attention to initialization/finalization when linking in units that have it.
