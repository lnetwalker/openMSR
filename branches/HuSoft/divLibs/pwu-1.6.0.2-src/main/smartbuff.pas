...
--------------------------------------------------------------------------------
 ...
 [02/MAR/2006 - Tony]
  ...
  - Created unit to organize buffering procedures instead of hardcoding
    ...
    [19 MAR - Tony Rearranged as true object ]

    [20 MAR - Tony rewrote as procedural code,  Wierd bug in object that
              turned out to be difficult to solve.   Moved gzip compression
              from pwumain to here.]
