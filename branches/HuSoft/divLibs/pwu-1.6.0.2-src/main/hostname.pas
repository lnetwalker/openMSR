...
begin
  ...
  begin
//    writeln('debug: begin hostname.inetresolve');
    he:= gethostbyname(PChar(address));
//    writeln('debug: 2 hostname.inetresolve');
//    if he = nil then 
//      writeln('debug: 3 NIL hostname.inetresolve');    
    if he <> nil then result.addr:= pin_addr(he^.h_addr_list^)^.S_addr;
//    writeln('debug : 4 hostname.inetresolve');    
  end;
end;
