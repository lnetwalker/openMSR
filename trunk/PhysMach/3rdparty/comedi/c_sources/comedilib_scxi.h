...
void comedi_scxi_close(scxi_mod_t *comedi_mod);
scxi_mod_t *comedi_scxi_open(comedi_t *dev, unsigned short chassis_address, unsigned short mod_slot);
int comedi_scxi_register_readwrite(scxi_mod_t *comedi_mod, unsigned short reg_address, unsigned int num_bytes,
