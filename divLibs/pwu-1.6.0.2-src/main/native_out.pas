...
// Could be different under windows. 
 uses windows;
  VAR
    STDOUT : HANDLE;
...
procedure NativeWrite(S : AnsiString);
procedure NativeWrite(Buffer : PChar;  NumChars : Cardinal);
procedure NativeWrite(PString : PChar); 
